...
// ================== WiFi ==================
const char* ssid     = "WirelessLab";
const char* password = "WSN11111";

// Flask (RTT/Log)
const char* serverPingUrl = "http://192.168.1.100:5000/ping";
const char* serverLogUrl  = "http://192.168.1.100:5000/log_rtt";

// Telemetry -> Flask
const char* serverTelemUrl = "http://192.168.1.100:5000/log_telemetry";
