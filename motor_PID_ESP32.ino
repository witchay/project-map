...
const int   STRAIGHT_MAX      = 90;   // ฐานตรง
const int   STRAIGHT_HARD_CAP = 85;   // เพดานตอนตรงชัด
const int   CURVE_MIN         = 58;   // ฐานต่ำสุดตอนโค้งจัด (ยิ่งต่ำยิ่งช้า)
const int   GLOBAL_MAX_PWM    = 92;   // เพดานรวม PWM (ทั้งเดินหน้า/ถอย)
